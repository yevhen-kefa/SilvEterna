...
COPY public.admin_users (id_user, date_creation) FROM stdin;
5	2025-05-18 17:48:01.259182
\.
...
1	R̩union	R̩union de projet	2023-10-03	09:00:00	10:00:00	Salle de r̩union	Professionnel
2	Anniversaire	Anniversaire de Marie	2023-10-04	19:00:00	22:00:00	Maison de Marie	Personnel
3	Conf̩rence	Conf̩rence sur IA	2023-10-05	14:00:00	16:00:00	Centre de conf̩rence	Professionnel
...
COPY public.users (id, avatar, nom, prenom, login, email, pass, datenaissance, telephone, statut, sexe, date_create) FROM stdin;
5	avatar_682a016f51829.jpg	Tayoken	Garde	tayoken	contact@tayoken.xyz	$2y$10$DaJK9sXHP3./Snb29XDpH.dqFIu.Yjmsnam017LvHUn0BhzpqCg6i	2006-11-02	07 66 36 26 67	actif	M	2025-05-12 15:51:25.056695
6	avatar_682a01a1117c3.jpeg	kasane	Teto	tetoUTAU	contact@teto.xyz	$2y$10$7WhV4.QMusKFgQwyq65ohOtSinj4lBgH9ds35Z61D61tgU9Fiilcu	2111-02-11	545454654534	actif	A	2025-05-18 17:49:53.026396
7	avatar_682a029fd10a4.jpg	Chartier 	Pierre	x2007	HeadofTrading@Volet.Hybrides	$2y$10$IAXBUhxODJMxvz1nW18MSOVEYPFA7VFhFNSjfc9B61DEO0vL/cgQS	2001-09-11	2007	actif	M	2025-05-18 17:53:29.01731
8	avatar_682a0ab830ba5.jpeg	Nigga	Goku	nigga	contact@nigga.xyz	$2y$10$RlWxkK84.eSS8WIOXJrTfun8A.QURG8H8nYTDUGqhUtfotZOtAMlG	2006-02-11	0755555555	actif	M	2025-05-18 18:28:40.194375
\.
...
SELECT pg_catalog.setval('public.agenda_id_agenda_seq', 2, true);
...
ALTER TABLE ONLY public.admin_users
    ADD CONSTRAINT admin_users_pkey PRIMARY KEY (id_user);
...
--
-- Name: admin_users admin_users_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.admin_users
    ADD CONSTRAINT admin_users_id_user_fkey FOREIGN KEY (id_user) REFERENCES public.users(id);
